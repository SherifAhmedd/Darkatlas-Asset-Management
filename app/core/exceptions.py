...
class NotFoundException(APIException):
    def __init__(
        self, message: str = "Resource not found", detail: Optional[dict] = None
    ):
...
class ConflictException(APIException):
    def __init__(
        self, message: str = "Resource conflict occurred", detail: Optional[dict] = None
    ):
...
class UnauthorizedException(APIException):
    def __init__(
        self, message: str = "Authentication failed", detail: Optional[dict] = None
    ):
...
class ForbiddenException(APIException):
    def __init__(
        self, message: str = "Forbidden access", detail: Optional[dict] = None
    ):
...
class ValidationException(APIException):
    def __init__(
        self, message: str = "Validation failed", detail: Optional[dict] = None
    ):
